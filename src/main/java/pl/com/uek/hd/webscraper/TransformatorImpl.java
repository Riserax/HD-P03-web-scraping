...
public class TransformatorImpl {
    ...
    public Set<Item> getItemsPojo() {
        return itemsPojo;
    }

    public void setItemsPojo(Set<Item> itemsPojo) {
        this.itemsPojo = itemsPojo;
    }

    public List<String> getTransformedItems() {
        return transformedItems;
    }

    public void setTransformedItems(List<String> transformedItems) {
        this.transformedItems = transformedItems;
    }

    public TransformatorImpl(List<HtmlElement> htmlItems){
        this.htmlItems = htmlItems;
